...
const Index = () => {
  ...
  const benefits = [
    ...
    { icon: 'Wand2', title: 'Работа с нейросетями', text: 'Ребёнок учится создавать изображения и видео с помощью ИИ' },
    { icon: 'Heart', title: 'Уверенность в идеях', text: 'Ребёнок перестаёт бояться пробовать новое' },
    { icon: 'Trophy', title: 'Итоговое видео', text: 'Собственный рисунок, оживлённый в видео с помощью нейросети' },
  ];
  ...
  const program = [
    ...
    { day: 'День 5', title: 'Оживляем рисунок: создание видео с помощью нейросети' },
    { day: 'День 6–7', title: 'Финальное видео и презентация работы' },
  ];
  ...
  const faq = [
    ...
    { q: 'Что получит ребёнок в итоге?', a: 'Собственное видео, созданное из своего рисунка с помощью нейросети, новые навыки и именной сертификат за завершение марафона.' },
  ];
        ...
        <div className="container grid items-center gap-10 py-16 lg:grid-cols-2 lg:py-24">
          <div className="animate-fade-up">
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              Онлайн-марафон, где дети учатся оживлять собственный рисунок с помощью
              нейросетей и превращают его в настоящее видео — спокойно, безопасно и с
              удовольствием.
            </p>
          ...
          <div className="grid items-center gap-8 sm:grid-cols-[auto_1fr]">
            ...
            <div>
              ...
              <p className="mt-3 text-muted-foreground">
                Педагогический и творческий опыт, работа с визуальным искусством,
                включая визуальные нейросети, и обучение детей. Спокойный, бережный
